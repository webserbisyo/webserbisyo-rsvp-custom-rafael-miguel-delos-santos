...
export function ClientRsvpPage({ config, event }: ClientRsvpPageProps) {
  ...
  return (
    <div className="wedding-rsvp-shell min-h-[100dvh] pt-28 pb-[var(--wedding-floating-clearance)] px-4 md:px-8 flex items-center justify-center relative overflow-hidden">
