...
export function CountdownToMusicDivider({
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom, transparent 0%, ${fromColor} 30%, ${toColor} 100%)`,
      }}
      aria-hidden="true"
    >
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[560px] overflow-x-clip select-none">
        <img
          ...
          height={2048}
          decoding="async"
          className="pointer-events-none absolute bottom-0 left-0 z-10 w-44 -translate-x-[2%] translate-y-[4%] select-none object-contain sm:w-52 sm:-translate-x-[14%] sm:translate-y-[12%] md:w-64 lg:w-80 xl:w-96"
        />
        <img
          ...
          height={2048}
          decoding="async"
          className="pointer-events-none absolute bottom-0 right-0 z-10 w-44 translate-x-[2%] translate-y-[4%] select-none object-contain sm:w-52 sm:translate-x-[14%] sm:translate-y-[12%] md:w-64 lg:w-80 xl:w-96"
        />
        <img
