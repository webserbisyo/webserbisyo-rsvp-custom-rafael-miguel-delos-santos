    ...
    <section id="venue" className="relative overflow-x-clip pt-24 pb-28 px-4 bg-cream">
      ...
      <div className="absolute inset-0 overflow-x-clip pointer-events-none z-10">
        ...
        <img
          ...
          height={2048}
          decoding="async"
          className="absolute top-2 left-0 sm:-top-16 sm:-left-16 md:-top-20 md:-left-24 lg:-top-20 lg:-left-32 w-28 sm:w-56 md:w-72 lg:w-[460px] xl:w-[540px] h-auto object-contain select-none opacity-85 sm:opacity-90 lg:opacity-95 transition-[opacity,transform] duration-300"
        />
        ...
        <img
          ...
          height={2048}
          decoding="async"
          className="absolute top-2 right-0 sm:-top-16 sm:-right-16 md:-top-20 md:-right-24 lg:-top-20 lg:-right-32 w-28 sm:w-56 md:w-72 lg:w-[460px] xl:w-[540px] h-auto object-contain select-none opacity-85 sm:opacity-90 lg:opacity-95 transition-[opacity,transform] duration-300"
        />
      </div>
