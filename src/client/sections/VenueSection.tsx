      ...
      <div className="max-w-6xl mx-auto relative z-30">
        ...
        <FadeContent>
          <div className="mt-16 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <SpotlightCard
              className="bg-white/65 backdrop-blur-md border border-sand/40 p-8 sm:p-10 rounded-3xl shadow-[color:var(--wedding-shadow-panel)] hover:border-sand/60 transition-[border-color,box-shadow] duration-500"
            ...
            <div className="flex flex-col items-center">
              {embedUrl ? (
                <div className="w-full bg-white border border-sand/20 rounded-[32px] p-3 sm:p-4 pb-5 sm:pb-7 shadow-[color:var(--wedding-shadow-panel)] relative transition-[border-color,box-shadow,transform] duration-500 hover:-translate-y-1">
                  ...
                  <div className="absolute -top-7 left-1/2 -translate-x-1/2 z-20 pointer-events-none select-none">
                    <Pin className="w-11 h-11 text-coral fill-current drop-shadow-[var(--wedding-shadow-pin)]" />
                  </div>
